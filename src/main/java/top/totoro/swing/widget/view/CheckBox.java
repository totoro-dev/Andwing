...
public class CheckBox extends View<ViewAttribute, JPanel> {
    ...
    public void setAttribute(ViewAttribute attribute) {
        ...
        Attribute selectedBoxIcon = element.attribute(selectedBoxIconKey);
        Attribute unselectedBoxIcon = element.attribute(unselectedBoxIconKey);
        Attribute isSelectedOn = element.attribute(isSelectedOnKey);
        // 初始化图标
    ...
    public void setIsSelected(boolean isSelected) {
        ...
        attribute.getElement().attributeValue(isSelectedOnKey, String.valueOf(isSelected));
        if (isSelected) {
            boxImgLabel.setIcon(selectedImg);
        } else {
            boxImgLabel.setIcon(unselectedImg);
