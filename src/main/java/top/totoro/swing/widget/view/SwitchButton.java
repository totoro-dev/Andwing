...
public class SwitchButton extends View<ViewAttribute, JLabel> {
    ...
    public void setIsSwitchOn(boolean isSwitchOn) {
        ...
        attribute.getElement().attributeValue(isSwitchOnKey, String.valueOf(isSwitchOn));
        if (mIsSwitchOn) {
    ...
    public void setAttribute(ViewAttribute attribute) {
        ...
        Attribute switchOn = element.attribute(switchOnKey);
        Attribute switchOff = element.attribute(switchOffKey);
        Attribute iSSwitchOn = element.attribute(isSwitchOnKey);
        if (switchOn != null) {
    ...
    public void mouseClicked(MouseEvent e) {
        ...
        attribute.getElement().attributeValue(isSwitchOnKey, String.valueOf(mIsSwitchOn));
        if (mIsSwitchOn) {
            component.setIcon(mSwitchOnIcon);
        } else {
            component.setIcon(mSwitchOffIcon);
